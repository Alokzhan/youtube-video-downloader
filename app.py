...
class DownloadHistory(db.Model):
    ...
    video_url = db.Column(db.String(500), nullable=False)  # Increased length for long URLs
    ...
    status = db.Column(db.String(20), nullable=False, default='success')  # Track failed/successful downloads
